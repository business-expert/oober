...
<div class="content-header">All Accounts</div>
        ...
        <aside class="right-side" style="margin-left:-26px;">
            ...
            <!-- Main content -->
                ...
                <div class="row">
                    <div class="col-lg-6" style="display:none;">
                        ...
                        <!-- Stack charts strats here-->
                          <div class="date">
							 {{  Form::open(array('action'=>'JoshController@accounts', 'id'=>'addcompa','method' => 'post','files' => 'true')) }}
			...
			<div class="table-cntnr transaction_show">
				...
				<!--<div class="num-item trans"> 
						{{ Form::open(array('method' => 'GET','url' => 'admin/accounts')) }}
...
<tr>
						<td><a href="{{ URL::to('admin/customer_details/' .$userr['id']) }}">{{ $userr['first_name'] }}</td>
						<td>{{ $userr['city'] }}</td>
						<td>{{ $userr['state'] }}</td>
						<td>@if(isset($userr['request'])){{ $userr['request'] }}@endif</td>
...
Chart.defaults.global.legend.display = false;
    ...
    </script><script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.7.0/js/bootstrap-datepicker.js"></script>
...
$(".sidebar").height($(document).height()/1.4);
	</script>
	<script>
