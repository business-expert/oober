    ...
    text-align: center;}
		...
		<section class="content _service">
			<div class=" no-pad  below-four">
				...
				<p>You should create a strong password that uses uppercase and lowercase letters, numbers. A password can be 6 to 30 characters long.
</p>
				 <div class="pasword-change">
		 {{  Form::open(array('action'=>'JoshController@password', 'method' => 'post')) }}
		 <ul class="pass">
		
		@if(isset($msg))<h4 style="color:black;"class="tk">{{ $msg }} </h4>@endif
			<li>Old password <input type="password" name="oldpassword"></li>
			<li>New password <input type="password" name="password"></li>
			<li>Re type Password <input type="password" name="newpassword"></li>
		 </ul>
